...
_STACK_COLS = {
    "search_cols": ["Category", "Guideline", "Keywords", "Description", "Do", "Don't"],
    "output_cols": ["Category", "Guideline", "Keywords", "Description", "Do", "Don't", "Code Good", "Code Bad", "Severity", "Docs URL"]
}
